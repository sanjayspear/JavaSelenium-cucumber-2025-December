...
public class Contact_Us_Steps extends Base_PO {
    ...
    // 👇 Required by Cucumber (no parameters)
    public Contact_Us_Steps() {
        super();                      // Base_PO has a no-arg constructor that does PageFactory.initElements(...)
        this.contact_us_po = new Contact_Us_PO();  // create your page object here
    }
